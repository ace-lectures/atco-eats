...
Avery (Citizen of Hamilton)::
    Avery lives in Stoney Creek, and work as an assistant manager in a local grocery store. With their partner, they have two teenage children, and enjoy spending quality time together dining in nice restaurants. They are not necessarily looking for fancy food, but more for nice, fun and positive atmosphere for their monthly family dinner. 
